...
subroutine check_igrid(ilevel,identifier)
  ...
  integer::ig,ip,npart1,npart2,icpu,identifier,ierr,info
           ...
           do jpart=1,npart1
              ...
              if(tp(ipart).ne.0)then
                 ...
                 if(igrid.ne.igrid_out) then
                    error=.true.
                    print *, 'ERROR: ipart,ilevel,myid,identifier = ', ipart,ilevel,myid,identifier
                    print *, 'ERROR: ipart,ilevel2,host_cpu = ', ipart,ilevel2,cpu_map(father(igrid_out))
                    print *, 'ERROR: igrid,igrid_out,icell_out = ', igrid,igrid_out,icell_out
...
111 format('   Entering check_igrid for level ',I2)
