...
module rt_cooling_module
  ...
  public rt_set_model, rt_solve_cooling, update_UVrates, cmp_chem_eq     &
         ...
         , rt_isoPress, rt_T_rad, rt_vc, a_r, rtPress_force
...
900 format (I3, '  myid=', I2, ' code=', I2, ' i=', I5, ' t=', 1pe12.3,  xs&
            ...
            ' nH=', 1pe12.3)
901 format ('  U      =', 40(1pe12.3))
902 format ('  dU     =', 40(1pe12.3))
903 format ('  dU/dt  =', 40(1pe12.3))
904 format ('  dU/U % =', 40(1pe12.3))
