...
subroutine read_hydro_params(nml_ok)
  ...
  namelist/physics_params/cooling,haardt_madau,metal,isothermal &
       ...
       & ,log_mfb,log_mfb_mega                                                     &
       & ,star_imf, n_dc, n_gmc, nsn2mass, star_maker, t_delay, SN_dT2_min         &
       & ,A_SN, A_SN_Geen,expN_SN, E_SNII, E_SNIa, SF_kick_kms, write_stellar_densities      &
...
105 continue
  ...
  !! Something going weird with stellar_winds_file
  if (myid==1) write(*,*)'stellar_winds_file=',trim(stellar_winds_file)
  !--------------------------------------------------
  ! Check for metal
  !--------------------------------------------------
